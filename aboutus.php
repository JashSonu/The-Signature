...
<body class="abt">
    ...
    <section class="about">
        <section class="about_desc">
            ...
            <div class="exp">
                <div>
                    <span>LOCATED IN A </span>
                    <span class="shiftup" style="margin-top: -0.3em;">SMALL TOWN !</span>
                </div>
                <div class="exp_25">
                    <h2>20<sub>+</sub></h2>
            ...
            <br>
            <div class="abouttext">
                <p>Our values include providing fair wages for workers, giving back to the communities we work, 
                    and serving great coffee.
                </p>
                <p>We imagine a world where there’s no such thing as a bad cup of coffee and all coffee farmers live prosperously. 
                </p>
            </div>
            <br>
            <br>
            <div class="founder"> 
                ...
                <div class="sign">
                    <img src="./Images/founder_sign.png" alt="">
                </div>
            </div>
        </section>
        <section class="about_img">
            <img src="./Images/about_restaurant.png" alt="" />
        </section>
    </section>
    <br>
    <br>
    ...
    <div class="container members">
            <section class="mem1">
                <img src="./Images/Jash.jpg" alt="Jash">
                <div class="overlay">
                    <h2>Jash Patel</h2>
                    <h4>BTech CS - E003</h4>
                </div>
            ...
            <section class="mem2">
                <img src="./Images/Arushi.jpg" alt="Arushi">
                <div class="overlay">
                    <h2>Arushi Pathik</h2>
                    <h4>BTech CS - E009</h4>
                </div>
            ...
            <section class="mem3">
                <img style="width:380px;" src="./Images/Saum.jpg" alt="Saumya">
                <div style="width:380px" class="overlay1">
                    <h2>Saumya Patni</h2>
                    <h4>BTech CS - E010</h4>
                </div>
            </section>
