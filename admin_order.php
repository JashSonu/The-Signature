...
?>
            ...
            <h3 class="id"><?php echo "Order ID #".$row["orderid"] ?></h3>
            <br>
                ...
                <tr class="item">
                    ...
                    <td style="color:white"><?php echo str_replace(", ","<br>",$row["dish"]); ?></td>
                    <td style="color:white"><?php echo str_replace(", ","<br>",$row["quantity"]); ?></td>
                    <td style="color:white"><?php echo str_replace(", ","<br>",$row["price"]); ?></td>
                    <td style="color:white"><?php echo str_replace(", ","<br>",$row["dishtotal"]); ?></td>
            ...
            <br>
<h3 class="contactd">CONTACT DETAILS</h3>
            <table cellpadding="0" cellspacing="0">
                <tr class="heading">
                    ...
                    <th width="7%">City</th>
                    <th width="7%">State</th>
                    <th width="7%">Pinocde</th>
                    <th width="13%">Payment Method</th>
                </tr>
                <tr class="details">
                    <?php 
                    $sql1 = "SELECT * FROM full_details WHERE ordid='$l'";
                    $result1 = mysqli_query($conn,$sql1);
                    if(mysqli_num_rows($result1)>0){
                    while($row1=mysqli_fetch_array($result1)){
                    ?>
                    <td style="color:white"><?php echo $row1["email"]; ?></td>
                    <td><?php echo $row1["hnum"]; ?></td>
                    <td style="color:white"><?php echo $row1["city"]; ?></td>
                    <td style="color:white"><?php echo $row1["state"]; ?></td>
                    <td style="color:white"><?php echo $row1["pincode"]; ?></td>
